...
export default function ProductDetailsPage() {
  ...
  const { addToCart } = useCartStore(); // ✅ only need addToCart here

  // ✅ Local counter for quantity
  ...
  return (
    <>
      ...
      <div className="bg-[rgba(245,62,50,1)] flex justify-between w-full px-35 py-4">
        ...
        <p className="font-poppins text-white text-[9px] font-medium">Home - Product</p>
      </div>

      {/*Page Layout */}
      <div className="flex flex-col scrollbar-hide justify-center box-sizing py-12 px-25">
        <div className="flex gap-6">
          {/* Sidebar */}
          <div className="bg-[rgba(247,247,248,1)] p-4 font-poppins border border-[rgba(233,233,233,1)] w-50 h-92">
            <p className="font-medium text-[11px] mb-1">Product Category</p>
            <hr className="border-[#d4d4d4] w-16 mx-auto" />
            ...
            {/* Product Tags */}
            <p className="font-medium text-[12px] mt-3 mb-1">Products Tags</p>
            <hr className="border-[#d4d4d4] w-16 mx-auto" />
          ...
          <div className="flex flex-col gap-8">
            <div className="ml-4 flex gap-4">
              {/* Image */}
              <div className="bg-[rgba(233,233,233,1)] h-94 rounded-xs w-70 flex items-center justify-center">
                <img
                  src={product?.image}
                  alt={product?.name}
              ...
              {/*  Product Details */}
              <div className="border-0 border-[rgba(233,233,233,1)] w-[471px] h-94 font-poppins flex flex-col justify-between">
                {/* Top Section */}
                <div>
            ...
            {/* Description Image */}
            <div>
              <img src="/description.png" alt="" className="w-170 h-75 ml-4" />
            </div>
          </div>
        </div>
        ...
        {/* Popular Section */}
        <div>
          <img src="/Popular.png" alt="" className="w-225 mt-10 mx-10" />
        </div>
      </div>
